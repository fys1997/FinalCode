...
parser.add_argument('--data',type=str,default='data/PEMS-BAY-12/',help='data path')
...
parser.add_argument('--encoderBlocks',type=int,default=1,help=' encoder block numbers')
parser.add_argument('--preTrain',type=bool,default=False,help='whether use preTrain model')
parser.add_argument('--seed',type=int,default=100,help='random seed')
parser.add_argument('--location_file',type=str,default='data/graph_sensor_locations_bay.csv',help='sensor location csv')
parser.add_argument('--distance_file',type=str,default='data/sensor_graph/SE(PeMS).txt',help='distance adjacency matrix file')
parser.add_argument('--clip',type=int,default=8,help='gradient norm clip')
parser.add_argument('--decoderBlocks',type=int,default=1,help='decoder block numbers')
